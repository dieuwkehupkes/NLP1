...
import io
import torch
from models_commai import EncoderRNN, LuongAttnDecoderRNN
...
from data_commai import random_batch
import Constants
...
def train_model():
    ...
    while epoch < opt.n_epochs:
        ...
        input_batches, input_lengths, target_batches, target_lengths = random_batch(opt.batch_size, vocab_source, vocab_target, train_pairs, opt.cuda)
